...
<head>
    ...
    <title>Cheina Care Givers</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 ">
                    ...
                    <p class="h5">You'll need:</p>
                    <ul>
                        <li class="mt-4">
                            <h5>At least one year of work experience</h5>
                        </li>
                        <li class="mt-4">
                            <h5>Up-to-date training certificates</h5>
                        </li>
                        <li class="mt-4">
                            <h5>
                                Two references
                    ...
                    <h5 class="mt-4">
                        See a <a class="h5" href="#">detailed checklist</a> of everything you need to start
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card w-100" style="border:none;">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Homes post their shifts to Cheina Care Givers daily</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risusas facilisis.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card w-100" style="border:none;">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Pick the shifts you want to work in one click</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risusas facilisis.
                            </p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card w-100" style="border:none;">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Submit your timesheet online, anytime, anywhere</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risusas facilisis.
                            </p>
                        </div>
